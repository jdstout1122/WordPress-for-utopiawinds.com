...
<section id="<?php echo $section_id; ?>" class="home-section-<?php echo $i; ?> <?php echo $section_css_class;?>">
       ...
       <?php  
		...
		?>
       <h2 class="section-title <?php echo $section_title_class; ?>"><?php echo $section_title; ?></h2>
        <?php endif;?>
