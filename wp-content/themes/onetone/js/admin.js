...
$(document).on('click','#add-section',function(){
	...
	$(this).before('<span class="get-pro-version" style="padding-left:20px;color:red;">Get the <a href="https://www.mageewp.com/onetone-theme.html" target="_blank">Pro version</a> of Onetone to acquire this feature.</span>');
	});
