...
class Options_Framework_Admin {
    ...
    public function init() {
		...
		add_action('wp_ajax_onetone_ajax_options', array( $this, 'ajax_options') );
		add_action('wp_ajax_nopriv_onetone_ajax_options', array( $this, 'ajax_options') );
	...
	function ajax_options(){
		...
		$sid = $_POST['sid'];
		$o_options = onetone_section_options($sid);
	
		$options   = array();
		foreach( $o_options as $k => $v ){
