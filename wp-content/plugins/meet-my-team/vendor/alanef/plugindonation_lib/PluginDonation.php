...
EOT;
	...
	public function set_strings() {
		$this->strings = array(
			...
			// 0
			esc_html__( 'Hi, I\'m Alan and I took over support and development of this plugin as I did not want it to die, and I hope you feel the same.', 'plugin-donation-lib' ),
			// 1
